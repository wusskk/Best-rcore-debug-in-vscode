...
/*
理想结果：输出 Test 04_5 ummap OK3811152764531961704562569816539036366413242653332365631741!
*/
...
fn main() -> i32 {
    ...
    println!("Test 04_5 ummap OK3811152764531961704562569816539036366413242653332365631741!");
    0
}
