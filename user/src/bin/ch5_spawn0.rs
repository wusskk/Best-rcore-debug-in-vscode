...
/*
理想结果：生成 MAX_CHILD 个 getpid 的子进程，全部结束后，输出 Test spawn0 OK10593845765509622145578366413242653332365631741!
*/
...
pub fn main() -> i32 {
    ...
    println!("Test spawn0 OK10593845765509622145578366413242653332365631741!");
    0
}
